...
@Composable
fun barangbekas(navController: NavHostController) {
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = { navController.navigate("reuce") }) {
                        Icon(
...
@Composable
fun InstructionBarangBekas() {
    Column(
        horizontalAlignment = Alignment.Start,
        modifier = Modifier.padding(16.dp)
    ) {
        Text(
            text = "Ide Kreatif untuk Menggunakan Ulang Barang Bekas",
            fontSize = 20.sp,
            color = Color.Black,
